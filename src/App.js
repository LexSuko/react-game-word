        ...
        <div className="card">
          ...
          {status !== "started" && (
            <div className="section-header">
              <h2>วิธีการเล่น</h2>
              <p>จะมีเวลาให้ 1 นาที พิมพ์ตามข้อความที่ปรากฏให้ถูกต้อง เมื่อมั่นใจว่าข้อความถูกให้กดปุ่ม Enter หรือ ถ้าข้อความเป็น<span>สีเขียว</span>ทั้งหมด ให้กดปุ่ม SpaceBar พอครบ 1 นาที จะมีการสรุปผลว่าภายใน 1 นาทีท่านทำได้กี่คะแนน</p>
            </div>
          )}
